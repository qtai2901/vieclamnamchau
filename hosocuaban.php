...
<button class="listBtn3" onclick="toggleForms3(this)"><a href="nhatuyendungtheodoi.php" style="color: black;"><i class="fa fa-heart" aria-hidden="true"></i></i> Nhà tuyển dụng đang theo dõi </a></button>
        ...
        <div class="profile-option">
            <div class="profile-option-content">
                <img src="https://png.pngtree.com/png-vector/20230728/ourmid/pngtree-filing-clipart-cartoon-tupperware-file-box-filled-with-documents-on-white-vector-png-image_6813263.png" alt="Hồ sơ trực tuyến">
                <div>
                    <h2>Hồ sơ trực tuyến <span class="recommended">Đề xuất</span></h2>
                    <p>Ứng tuyển thuận tiện hơn với hồ sơ trên website Việc làm 24h</p>
                </div>
            </div>
            <a href="taohosotructuyen.php"><button id="create-button1" class="create-button">Tạo hồ sơ trực tuyến</button></a>
        </div>
        <div class="profile-option">
            <div class="profile-option-content">
                <img src="https://png.pngtree.com/png-vector/20230728/ourmid/pngtree-filing-clipart-cartoon-tupperware-file-box-filled-with-documents-on-white-vector-png-image_6813263.png" alt="Hồ sơ đính kèm">
                <div>
                    <h2>Hồ sơ đính kèm</h2>
                    <p>Ứng tuyển nhanh chóng hơn với hồ sơ sẵn có</p>
                </div>
            </div>
          <a href="taohosotructuyen.php">  <button id="create-button1">Tạo hồ sơ đính kèm</button></a>
        </div>
    </div>
