...
<button class="listBtn3" onclick="toggleForms3(this)"><a href="nhatuyendungtheodoi.php" style="color: black;"><i class="fa fa-heart" aria-hidden="true"></i></i> Nhà tuyển dụng đang theo dõi </a></button>
        ...
        <section class="applied-jobs">
            ...
            <div class="job-list">
                <p>Bạn chưa có việc làm đã ứng tuyển</p>
                <img src="imgs/anhchuaungtuyen.png" alt="Empty State Image">
            </div>
            <div class="filter">
                <label for="filter">Bộ lọc:</label>
                <select id="filter">
                     <option value="pending">Tất cả trạng thái</option>
                    <option value="pending">Chờ duyệt</option>
                     <option value="pending">Nộp thành công</option>
                      <option value="pending">Không được duyệt</option>
                </select>
            </div>
        </section>
