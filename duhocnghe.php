...
,Tìm việc làm Nhân viên kinh doanh" />
   ...
   <body>
    ...
    <div id="body" class="footer w100 fl top-20">
       <h2 style = "text-align: center; color: blue; ">Danh Sách Các Trường Tại 5 Châu </h2>
      ...
      <button id = "searchduhocnghe" class="searchduhocnghe" style = "height: 50px; weight:80%;">Tìm kiếm <i class="fa fa-search" aria-hidden="true"></i></button>
        </div>
    <?php foreach (get_list("SELECT * FROM `duhocnghe`",$conn) as $row) { ?>
    <div class="col-md-4 col-xs-12">
        <img src="image/<?php echo $row['anhminhhoa']?>" alt="Ảnh mô tả" style="margin-top:30px; width: 450px; height: 250px;">
        <h3 style="margin-top: 20px; color:blue;"> Danh Sách Các Trường Tại <?echo $row['quocgia']?> </h3>
        <a href="chitiettruong.php?id=<?echo $row['id']?>" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>
    </div>
<?php }?>
