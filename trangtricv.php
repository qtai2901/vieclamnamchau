        ...
        <div class="cv-templates">
            <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv.png" alt="CV 1">
                 <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
             <div class="cv-template" data-category="simple professional" >
           ...
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
             ...
             <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv2.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
              <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv3.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
              <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv4.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
              <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv5.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
              <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv10.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
              <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv6.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
             <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv7.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
             <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv8.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
             <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv9.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
            
             <div class="cv-template" data-category="simple professional" >
                <img src="imgs/cv11.png" alt="CV 1">
           <a href="cv.php" ><button class="use-template-button" id="use-template-button">Dùng mẫu này</button></a>
            </div>
...
function toggleFormslis(listBtn) {
   ...
   <script>
    ...
    var templates = document.querySelectorAll('.cv-template');

    templates.forEach(function(template) {
        if (selectedCategory === 'all' || template.getAttribute('data-category').includes(selectedCategory)) {
