...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == 'dangkyduhoc' || $action == 'luuduhoc') {
        ...
        $stmt = $conn->prepare("INSERT INTO duhocnghe (chauluc, quocgia, tieude, gioithieu, anhminhhoa, tenminhhoa, mucso1, anhminhhoa1, tenanh1, mucso2, anhminhhoa2, tenanh2, mucso3, anhminhhoa3, tenanh3, mucso4, anhminhhoa4, tenanh4, mucso5, anhminhhoa5, tenanh5, doanket) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        header("Location: ../taotinduhocnghe.php");
            exit();
                // }
