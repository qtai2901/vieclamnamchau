...
<form id ="formb3">
 ...
 <button class="listBtn3" onclick="toggleForms3(this)"><a href="quangba.php" style="color: black;"><i class="fa fa-heart" aria-hidden="true"></i></i> Quảng bá thương hiệu </a></button>
        ...
        <button class="capnhat_gioithieu" style="background-color: #8a2be2;color: #fff; margin-top:80px;margin-left:680px; width: 200px; height: 50px;">Cập Nhật</button>
            ...
            <h3 style="margin-left:40px;color:blue;">Ảnh Bìa Công Ty</h3>

             <div style="margin-top:40px;"> Ảnh bìa hiện tại<span style="color:red;">* </span></div>
        ...
        <button type="submit" name="action" value="dangkyduhoc" class="btn btn-primary" style="margin-left: 10px;margin-top: 40px; margin-bottom: 100px;background-color: #007bff;"><i class="fa fa-paper-plane" aria-hidden="true"></i>Thay đổi ảnh bìa</button>
    </div>
    <div class="col-md-4 col-xs-12">
        <button type="submit" name="action" value="luuduhoc" class="btn btn-primary" style="color:blue;margin-left: 10px;margin-top: 40px; margin-bottom: 100px;background-color: #007bff;"><i class="fa fa-paper-plane" aria-hidden="true"></i>Xem trang công ty của tôi <i class="fa fa-external-link" aria-hidden="true"></i></button>
    </div>
