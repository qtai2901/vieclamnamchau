...
<button class="listBtn3" onclick="toggleForms3(this)"><a href="quangba.php" style="color: black;"><i class="fa fa-heart" aria-hidden="true"></i></i> Quảng bá thương hiệu </a></button>
        ...
        <h2 style= "color: #08088A;">Hồ Sơ Đã Lưu</h2>
<div style="display: flex; align-items: center; margin-top 40px;">
   
    <h3 style="margin-left: 10px;margin-top:60px;">
Hồ sơ đã lưu: <span style="color:red;"> 0</span></h3>

<span style="margin-left: 50px;margin-top:60px;"><i class="fa fa-exclamation-circle" aria-hidden="true" style="color: #F7D358;"></i>
Hồ sơ bị xoá hoặc ẩn bởi ứng viên sẽ không thể tải xuống.Danh sách hồ sơ sẽ bị xoá sau 6 tháng</span>
...
<option value="">Nhập tên hồ sơ</option>
...
<div class="form-group col-dk-2 col-md-2 col-xs-12" style="margin-left:20px;">
    
    <select class="form-control show-select" id="chose-option-nganh-empty">
<option value="">Tất cả thời gian đã lưu</option>
...
<input type="checkbox" id="tick_hoso"style = "margin-left: 30px;"  >
    ...
    <label for="vịtri" style = "margin-left: 160px; margin-top:8px;"> Tình trạng </label>
    <label for="thoihannop" style = "margin-left: 160px; margin-top:8px;"> Ngày lưu </label>
   
    <label for="trangthaituyendung" style = "margin-left: 160px; margin-top:8px;"> Trạng thái tuyển dụng </label>
</div>
<div class="line" style ="margin-top: 20px;"></div>
<div style="display: flex; align-items: center;margin-top: 30px;">
