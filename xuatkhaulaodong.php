...
<div id="body" class="footer w100 fl top-20">
    <h1 style="text-align: center; color: #5858FA;" >Danh Sách Việc Làm Xuất Khẩu Lao Động Tại 5 Châu<h1>
     <div class="col-md-12 col-xs-12">
        ...
        <button class="searchBtn">Tìm kiếm <i class="fa fa-search" aria-hidden="true"></i></button>
        </div>
     </div>

<?php foreach (get_list("SELECT * FROM `xkld`",$conn) as $row) { ?>
     <div class="col-md-4 col-xs-12">
     <img src="image/<?echo $row['anhminhhoa']?>" alt="Ảnh mô tả"style="margin-top:30px; width: 450px; height: 250px;">
    <h3 style ="margin-top: 20px; color:blue;"> Danh Sách Các Công Việc Tại <?echo $row['quocgia']?> </h3>
        <a href="chitietcongviec.php?id=<?echo $row['id']?>" style="font-size: small; opacity: 0.5; color:black;margin-top: 5px; "> Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>
     </div>
